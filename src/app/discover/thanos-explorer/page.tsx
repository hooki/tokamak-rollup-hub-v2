          ...
          <Flex flexDir={"column"} gap={"45px"}>
            <Flex flexDir={"column"} gap={"6px"}>
              ...
              <Text fontSize={"15px"} fontWeight={400} lineHeight={"18px"}>
                ...
                <br />
                With the Thanos Explorer, users can: <br />- Track transactions
                and their status in real-time including deposit/withdrawal
                status since it is especially designed for the Thanos Stack{" "}
                <br />- View detailed information about blocks, including block
                height, timestamp, and transactions included <br />- Explore
                smart contracts, including their code, transactions, and
                interactions <br />- Analyze network statistics, such as block
                time, gas usage, and network congestion <br />
                <br />
                ...
                growth and adoption of the Thanos Stack by making it easier for
                users to understand and engage with the blockchain.
              </Text>
            </Flex>
            <Box
              px={"30px"}
              bg={"url(/images/thanos-explorer-bg.jpg) no-repeat center center"}
              bgSize={"cover"}
              width={"100%"}
              borderRadius={"15px"}
              border={"1px solid #E1E8ED"}
            ...
            <Flex flexDir={"column"} gap={"6px"}>
              ...
              <Text fontSize={"15px"} fontWeight={400} lineHeight={"18px"}>
                ...
                Thanos Stack deployment using the deployment SDK, as detailed in{" "}
                <Link
                  _hover={{ textDecoration: "underline" }}
                  color={"#0070ED"}
                  href={
        ...
        >
          ...
          <Flex flexDir={"column"} gap={"9px"}>
            ...
            <Text fontSize={"14px"} fontWeight={400} lineHeight={"17px"}>
              ...
              doesn&apos;t require any contract deployment. All you need to pay
              for it is the operation cost in the cloud provider or on-premise
              server.
            </Text>
          </Flex>
        </Flex>
