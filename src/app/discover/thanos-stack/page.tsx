      ...
      >
          ...
          <Flex flexDir={"column"} gap={"45px"}>
            <Flex flexDir={"column"} gap={"6px"}>
              ...
              <Text fontSize={"15px"} fontWeight={400} lineHeight={"18px"}>
                ...
                market, we can utilize ERC20 tokens as native tokens at layer 2.
                The Tokamak Network aims to create a flexible ecosystem that
                supports on-demand Layer 2 solutions tailored to the needs of
                users. This flexibility allows dApp developers and operators to
                choose and manage the Layer 2 chain that best suits the specific
                needs of their application. <br />
                The Thanos Stack is the first Layer 2 stack in Tokamak that will
                serve as the cornerstone for building on-demand Layer 2 chains.
              </Text>
            </Flex>
            <Box
              px={"30px"}
            ...
            <Flex flexDir={"column"} gap={"6px"}>
              ...
              <Text fontSize={"15px"} fontWeight={400} lineHeight={"18px"}>
                This stack is supported for deployment on local devnet, testnet
                (Sepolia), and Ethereum Mainnet by SDK following{" "}
                <Link
                  _hover={{ textDecoration: "underline" }}
                  color={"#0070ED"}
                  href={
                ...
                . For the infrastructure of the testnet and mainnet deployment,
                we currently offer support for AWS in our deployment SDK.
                Support for other cloud providers such as GCP and Azure is in
                the pipeline.
              </Text>
            </Flex>
            <Flex flexDir={"column"} gap={"6px"}>
              ...
              <Text fontSize={"15px"} fontWeight={400} lineHeight={"18px"}>
                ...
                you want to contribute to the thanos chain, please feel free to
                create a PR on{" "}
                <Link
                  _hover={{ textDecoration: "underline" }}
                  color={"#0070ED"}
        ...
        >
            ...
            <List.Root ml={"15px"}>
              ...
              <List.Item fontSize={"14px"} fontWeight={700} lineHeight={"17px"}>
                ...
                <Text
                  ...
                  lineHeight={"17px"}
                >
                  - Provides a development environment that mirrors the familiar
            ...
            <List.Root ml={"15px"}>
              ...
              <List.Item fontSize={"14px"} fontWeight={700} lineHeight={"17px"}>
                ...
                >
                  ...
                  Network ecosystem to earn seigniorage rewards proportional to
                  the L2 growth.
                </Text>
              </List.Item>
            </List.Root>
          ...
          <Flex flexDir={"column"} gap={"9px"}>
            ...
            <Text fontSize={"14px"} fontWeight={400} lineHeight={"17px"}></Text>
          </Flex>
        </Flex>
      </Flex>
    </Flex>
